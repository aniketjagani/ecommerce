...
from .models import Category, Product, Cart, Cart_Item, Order, OrderItem
        ...
        try:
            ...
            try:
                ...
                for order_item in cart_items:
                    ...
                    # print when the order is created
...
def sendEmail(order_id):
    ...
    try:
        subject = "E-commerce Store - New Order #{}".format(transaction.id)
        to = ['{}'.format(transaction.emailAddress)]
        from_email = "jaganianiket@gmail.com"
        order_information = {
